...
export const corporateActions: CorporateAction[] = [
  ...
  {
    id: 'ca-004',
    actionSummarizedTitle: 'Duplicate Account suspected: "Acme Corp" vs "Acme Corporation"',
    actionDetails: 'Two Account records found with similar names: "Acme Corp" (acct-045, created 2026-01-15) and "Acme Corporation" (acct-112, created 2026-03-22). Both have the same registered address and one contact with same email. Recommend manual review and merge.',
    priority: 'Low',
    status: 'New',
    dueDate: '2026-06-01',
    createdAt: '2026-05-13T14:00:00Z',
    modifiedAt: '2026-05-13T14:00:00Z',
  },
  {
    id: 'ca-005',
    actionSummarizedTitle: 'May 2026 exchange rate not yet pinned for USD→RON',
    actionDetails: 'No ExchangeRate snapshot exists for May 2026 from USD to RON. Two USD invoices issued this month will fall back to the latest available rate (April 2026). Recommend uploading the official BNR rate for May before month-end.',
    priority: 'Medium',
    status: 'In Progress',
    dueDate: '2026-05-31',
    createdAt: '2026-05-10T07:00:00Z',
    modifiedAt: '2026-05-14T10:15:00Z',
  },
  {
    id: 'ca-006',
    actionSummarizedTitle: 'Timesheet for week 19 not submitted by 2 consultants',
    actionDetails: 'Consultants Aleksandar Petrov and Diana Marinescu have not submitted their week 19 timesheets (week ending 2026-05-10). Submission deadline was 2026-05-12. Invoice generation for these clients may be delayed.',
    priority: 'Medium',
    status: 'New',
    dueDate: '2026-05-17',
  ...
  {
    id: 'ca-007',
    actionSummarizedTitle: 'Expense EX-2026-0034 missing receipt attachment',
    actionDetails: 'Expense EX-2026-0034 (Travel, €420, submitted by Andreea Tudor) was approved without a receipt attached. Per policy, all expenses over €50 require an attached receipt for VAT recoverability. Recommend requesting receipt from the submitter.',
    priority: 'Low',
    status: 'New',
    dueDate: '2026-05-25',
  ...
  {
    id: 'ca-008',
    actionSummarizedTitle: 'Public holidays for 2027 not loaded',
    actionDetails: 'No PublicHoliday records exist for year 2027 in any of the three business entities (RO, BG, US). Working-day calculations in Reports and Timesheets will be inaccurate for any forward-looking forecast that crosses 2027.',
    priority: 'Low',
    status: 'New',
    dueDate: '2026-12-31',
    createdAt: '2026-05-13T16:00:00Z',
  ...
  {
    id: 'ca-009',
    actionSummarizedTitle: 'Prospect "Hephaestus Holdings" idle for 21 days',
    actionDetails: 'Prospect Hephaestus Holdings has had no interaction logged in the last 21 days, despite being marked at "Negotiating" stage with estimated value of €180,000. Recommend logging a status check or reassigning ownership.',
    priority: 'Medium',
    status: 'Closed',
    closingComments: 'Reached out to client on 2026-05-13. Confirmed they are still evaluating; rescheduled follow-up for 2026-05-28. Closing this action.',
    dueDate: '2026-05-12',
    createdAt: '2026-05-05T09:30:00Z',
    modifiedAt: '2026-05-13T11:45:00Z',
  },
  {
    id: 'ca-010',
    actionSummarizedTitle: 'Dividend declaration missing for Q1 2026',
    actionDetails: 'No Dividend records found for Q1 2026 for the Romanian business entity. Per the shareholder agreement, dividend resolutions should be recorded within 90 days of the quarter close.',
    priority: 'Medium',
    status: 'Cancelled',
    closingComments: 'Per Marius: dividend declaration intentionally deferred to Q2 due to capital reinvestment plan. Will be recorded as a single H1 2026 distribution. Closing without action.',
    dueDate: '2026-05-15',
    createdAt: '2026-05-08T09:00:00Z',
    modifiedAt: '2026-05-12T15:30:00Z',
  },
  {
    id: 'ca-011',
...
export const accounts: Account[] = [
  ...
  { id: 'acc-12', accountNumber: 'CSP-000012', name: 'Innovate Solutions', accountType: 'Direct Customer', entityId: 'ent-1', country: 'Netherlands', vatNumber: 'NL123456789B01', paymentTerms: '30 Days', status: 'Active', activeContracts: 0, email: 'info@innovate.nl' },
...
export const expenses: Expense[] = [
  ...
  { id: 'exp-8', reference: 'EXP-000008', entityId: 'ent-1', accountId: 'acc-6', expenseType: 'Contractor Payment', contractId: 'ctr-1', currencyCode: 'EUR', totalAmount: 9163, vatAmount: 1463, netAmount: 7700, dateIssued: '2026-02-10', dueDate: '2026-02-25', status: 'Pending', periodMonth: 1, periodYear: 2026 },
  { id: 'exp-9', reference: 'EXP-000009', entityId: 'ent-1', accountId: 'acc-6', expenseType: 'Contractor Payment', contractId: 'ctr-2', currencyCode: 'EUR', totalAmount: 8377.6, vatAmount: 1337.6, netAmount: 7040, dateIssued: '2026-02-10', dueDate: '2026-02-25', status: 'Pending', periodMonth: 1, periodYear: 2026 },
  { id: 'exp-10', reference: 'EXP-000010', entityId: 'ent-2', accountId: 'acc-7', expenseType: 'Contractor Payment', contractId: 'ctr-3', currencyCode: 'GBP', totalAmount: 7854, vatAmount: 1254, netAmount: 6600, dateIssued: '2026-02-10', dueDate: '2026-02-25', status: 'Pending', periodMonth: 1, periodYear: 2026 },
  { id: 'exp-11', reference: 'EXP-000011', entityId: 'ent-3', accountId: 'acc-8', expenseType: 'Contractor Payment', contractId: 'ctr-5', currencyCode: 'USD', totalAmount: 13200, vatAmount: 0, netAmount: 13200, dateIssued: '2026-02-10', dueDate: '2026-02-25', status: 'Pending', periodMonth: 1, periodYear: 2026 },
  ...
  { id: 'exp-13', reference: 'EXP-000013', entityId: 'ent-2', accountId: 'acc-7', expenseType: 'Contractor Payment', contractId: 'ctr-6', currencyCode: 'EUR', totalAmount: 9163, vatAmount: 1463, netAmount: 7700, dateIssued: '2026-02-10', dueDate: '2026-02-25', status: 'Pending', periodMonth: 1, periodYear: 2026 },
  ...
  { id: 'exp-15', reference: 'EXP-000015', entityId: 'ent-1', accountId: 'acc-13', expenseType: 'Operating Cost', currencyCode: 'EUR', totalAmount: 2380, vatAmount: 380, netAmount: 2000, dateIssued: '2026-03-01', dueDate: '2026-03-15', status: 'Pending', periodMonth: 3, periodYear: 2026 },
];
...
export const dividends: Dividend[] = [
  { id: 'div-1', name: 'DIV-001', entityId: 'ent-1', amount: 15000, currencyCode: 'EUR', paymentDate: '2025-12-20', taxWithheld: 750, netAmount: 14250 },
  { id: 'div-2', name: 'DIV-002', entityId: 'ent-1', amount: 10000, currencyCode: 'EUR', paymentDate: '2025-12-20', taxWithheld: 500, netAmount: 9500 },
];
...
export const availabilitySlots: AvailabilitySlot[] = ([
  { id: 'slot-1', candidateId: 'cand-1', dayOfWeek: 'Monday', startTime: '10:00', endTime: '10:15', date: '2026-04-13', teamsLink: 'https://teams.microsoft.com/l/meetup-join/slot1', isActive: true, status: 'Fully Booked', interviewerId: 'con-1', confirmedAt: '2026-04-11' },
  { id: 'slot-2', candidateId: 'cand-2', dayOfWeek: 'Monday', startTime: '14:00', endTime: '14:15', date: '2026-04-13', teamsLink: 'https://teams.microsoft.com/l/meetup-join/slot2', isActive: true, status: 'Expired', interviewerId: 'con-4', confirmedAt: '2026-04-10' },
  { id: 'slot-3', candidateId: 'cand-3', dayOfWeek: 'Wednesday', startTime: '09:00', endTime: '09:15', date: '2026-04-15', teamsLink: '', isActive: true, status: 'Available'},
  { id: 'slot-4', candidateId: 'cand-4', dayOfWeek: 'Wednesday', startTime: '15:00', endTime: '15:15', date: '2026-04-15', teamsLink: '', isActive: true, status: 'Available'},
  { id: 'slot-5', candidateId: 'cand-5', dayOfWeek: 'Friday', startTime: '10:00', endTime: '10:15', date: '2026-04-17', teamsLink: '', isActive: true, status: 'Available'},
  { id: 'slot-6', candidateId: 'cand-6', dayOfWeek: 'Thursday', startTime: '16:00', endTime: '16:15', date: '2026-04-09', teamsLink: '', isActive: true, status: 'Fully Booked', interviewerId: 'con-8', confirmedAt: '2026-04-08' },
  { id: 'slot-7', candidateId: 'cand-7', dayOfWeek: 'Tuesday', startTime: '11:00', endTime: '11:15', date: '2026-03-25', teamsLink: '', isActive: false, status: 'Expired' },
  { id: 'slot-8', candidateId: 'cand-8', dayOfWeek: 'Friday', startTime: '14:00', endTime: '14:15', date: '2026-04-10', teamsLink: 'https://teams.microsoft.com/l/meetup-join/slot8', isActive: true, status: 'Expired', interviewerId: 'con-1', confirmedAt: '2026-04-09' },
...
export const prospects: Prospect[] = [
  ...
  { id: 'pro-23', prospectNumber: 'PRO-0023', companyName: 'Saffron Foods', country: 'India', industry: 'FoodTech', ownerContactId: 'con-1', source: 'LinkedIn', primaryContactName: 'Arjun Mehta', primaryContactEmail: 'arjun@saffronfoods.in', primaryContactRole: 'Head of Tech', needDescription: 'Supply chain visibility platform.', estimatedValue: 130000, currencyCode: 'EUR', status: 'Contacted', firstContactDate: '2026-04-05', lastActivityDate: '2026-04-14' },
  { id: 'pro-24', prospectNumber: 'PRO-0024', companyName: 'Halcyon Pharma', country: 'Belgium', industry: 'Pharma', ownerContactId: 'con-4', source: 'Internal Referral', primaryContactName: 'Inge Vermeulen', primaryContactEmail: 'inge@halcyon-pharma.be', primaryContactRole: 'Head of Validation', needDescription: 'GxP-compliant data pipelines.', estimatedValue: 290000, currencyCode: 'EUR', status: 'Proposal', firstContactDate: '2026-03-15', lastActivityDate: '2026-04-10' },
